        ...
        <div class="property-card property-id-<? = $property['id'] ?> row">
            ...
            <div class="content-container col-md-8">
                <div class="row no-gutters justify-content-between">
                    ...
                    <div class="star-container" title=><!--title="4.5"-->
                        <?php
                            $rating = $total_rating;
                            for($i=0;$i<5;$i++){
                                if($rating >= $i+ 0.8){
                    ...
                    <div class="interested-container">
                        ...
                        ?>
                            <i class="is-intrested-image far fa-heart" property_id="<?php $property['id'] ?>"></i>
                        <?php } ?>
                        <div class="interested-text">
                            <span class = "interested-user-count"><?= $interested_users_count ?></span>
                            interested
                        </div>
                    </div>
                </div>
