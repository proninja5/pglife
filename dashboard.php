<?php
    ...
    $user = mysqli_fetch_assoc($result_1); //storing user_id in $user variable
    if(!$user){
        echo "Something went wrong!";
        return;
    }
    ...
    $interested_properties = mysqli_fetch_all($result_2,MYSQLI_ASSOC); //storing property id in $interested_properties variable
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <!-- if interested properties are marked by the user from the current account. -->
    <?php 
    ...
    ?>
        <div class="my-interested-properties">
            ...
            ?>
                <div class="property-card property-id-<?php $proeprty['id'] ?> row">
                    ...
                    <div class="content-container col-md-8">
                        ...
                        <div class="row no-gutters">
                            <div class="rent-container col-6">
                                <div class="rent">Rs <?php number_format($property['rent']) ?>/-</div>
                                <div class="rent-unit">per month</div>
                            </div>
                            <div class="button-container col-6">
                                <a href="property_detail.php? property_id=<?php $property['id'] ?>" class="btn btn-primary">View</a>
                            </div>
                        </div>
                    </div>
                </div>
