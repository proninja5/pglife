...
<body>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            ...
            foreach($property_images as $index => $property_images) {
            ?>
            ...
            <div class="row justify-content-between">
                <div class="col-md-auto">
                    ...
                    <div class="amenity-container">
                        <img src="img/amenities/<?= $amenity['icon'] ?>.svg"><span><?= $amenity['name'] ?></span>
                    </div>
                    <?php 
                        }
                    } 
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    ...
                    <div class="rating-criteria row">
                        ...
                        <div <div class="rating-criteria-star-container col-6" title="<?= $property['rating_food'] ?>">
                            <?php
                    ...
                    <div class="rating-criteria row">
                        ...
                        <div <div class="rating-criteria-star-container col-6" title="<?= $property['rating_safety'] ?>">
                            <?php
